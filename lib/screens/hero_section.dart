      ...
      child: Column(
        ...
        children: [
            ...
            child: SelectableText.rich(
              TextSpan(
                ...
                children: const [
                  ...
                  TextSpan(text: '= ', style: TextStyle(color: AppColors.textPrimary)),
                  TextSpan(text: "'6+'", style: TextStyle(color: Color(0xFFC3E88D))),
                  TextSpan(text: ';\n', style: TextStyle(color: AppColors.textPrimary)),
          ...
          Wrap(
            ...
            children: const [
              PillTag('Flutter 4.x', style: PillStyle.indigo),
              ...
              PillTag('Automation',        style: PillStyle.emerald),
              PillTag('n8n',        style: PillStyle.indigo),
              PillTag('AI',        style: PillStyle.sky),
            ],
          ),
        ],
      ),
